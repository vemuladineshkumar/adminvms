 ...
 <div class="main-panel">
        ...
        <a href="addsubcategory.php"> ADD </a> 
                    ...
                    <table class="table table-bordered">
                      ...
                      <tbody>
                          <?php
                          $category="SELECT * FROM sub_category";
                          $cat_listview = array();
       ...
       ?>
                        ...
                        <tr class="table-info">
                        <td>
                            <?php echo $catlist['subcat_id']; ?>
                          </td>
                        <td>
                            <?php echo $catlist['cat_id']; ?>
                          </td>
                          <td>
                          <?php echo $catlist['subcat_name']; ?>
                          </td>
                         
                          <td>
                          <a href="editsubcategory.php?id=<?php echo $catlist['subcat_id'];?>"><i class="fa fa-pencil-square-o"></i>
